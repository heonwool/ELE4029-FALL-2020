...
{ int i;
  ...
  while (tree != NULL) {
    ...
    { printSpaces();
      switch (tree->kind.decl) {
        case VarK:
          ...
          break;
        case VarArrK:
          fprintf(listing,"Variable (Array) declaration, name : %s, size: %d, type : %s\n",tree->attr.array.name,tree->attr.array.size,getType(tree));
          break;
        case FunK:
    ...
    { if(tree->kind.exp != TypeNameK) printSpaces();
      ...
      switch (tree->kind.param) {
        ...
        case SingleParamK:
          if(tree->attr.name != NULL)
            ...
            fprintf(listing,"Parameter, name : (NULL), type : %s\n",getType(tree));
          break;
        default:
